...
private:
    ...
    void insert(const string& x, BinaryNode*& tree);
    bool find(const string& x, BinaryNode* tree) const;
    // string pathTo(const string& x, BinaryNode* tree) const;
    string pathTo(const string& x, BinaryNode* tree, string temp) const;
